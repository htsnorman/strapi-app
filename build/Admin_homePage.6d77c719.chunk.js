"use strict";(self.webpackChunkstarpi_app=self.webpackChunkstarpi_app||[]).push([[3981],{36717:($e,M,n)=>{n.r(M),n.d(M,{default:()=>Fe});var e=n(67294),f=n(97132),c=n(16384),D=n(15482),j=n(49656),i=n(68547),O=n(78862),F=n(62031),d=n(5493),g=n(34626);const W=n.p+"fb376b132d18bf4522ca.png";var V=n(78143);const $=t=>Object.entries(t).every(([,a])=>Object.entries(a).every(([,o])=>o));var E=n(9008),v=n(67826),h=n(49425),L=n(19408),A=n(77602),H=n.n(A),z=n(45697),r=n.n(z),K=n(96392),Z=n(89285),m=n(99872);const C=({type:t,title:a,number:o,content:l,hasLine:p})=>{const{formatMessage:y}=(0,f.useIntl)();return e.createElement(d.Box,null,e.createElement(v.Flex,null,e.createElement(d.Box,{minWidth:(0,i.pxToRem)(30),marginRight:5},e.createElement(K.Z,{type:t,number:o})),e.createElement(h.Typography,{variant:"delta",as:"h3"},y(a))),e.createElement(v.Flex,{alignItems:"flex-start"},e.createElement(v.Flex,{justifyContent:"center",minWidth:(0,i.pxToRem)(30),marginBottom:3,marginTop:3,marginRight:5},p&&e.createElement(Z.Z,{type:t,minHeight:t===m.lW?(0,i.pxToRem)(85):(0,i.pxToRem)(65)})),e.createElement(d.Box,{marginTop:2},t===m.lW&&l)))};C.defaultProps={content:void 0,number:void 0,type:m.VM,hasLine:!0},C.propTypes={content:r().node,number:r().number,title:r().shape({id:r().string,defaultMessage:r().string}).isRequired,type:r().oneOf([m.lW,m.hx,m.VM]),hasLine:r().bool};const N=C,U=(t,a)=>t===-1||a<t?m.hx:a>t?m.VM:m.lW,T=({sections:t,currentSectionKey:a})=>{const o=t.findIndex(l=>l.key===a);return e.createElement(d.Box,null,t.map((l,p)=>e.createElement(N,{key:l.key,title:l.title,content:l.content,number:p+1,type:U(o,p),hasLine:p!==t.length-1})))};T.defaultProps={currentSectionKey:void 0},T.propTypes={sections:r().arrayOf(r().shape({key:r().string.isRequired,title:r().shape({id:r().string,defaultMessage:r().string}).isRequired,content:r().node})).isRequired,currentSectionKey:r().string};const J=T;var Y=n(64729),Q=Object.defineProperty,P=Object.getOwnPropertySymbols,X=Object.prototype.hasOwnProperty,w=Object.prototype.propertyIsEnumerable,b=(t,a,o)=>a in t?Q(t,a,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[a]=o,q=(t,a)=>{for(var o in a||(a={}))X.call(a,o)&&b(t,o,a[o]);if(P)for(var o of P(a))w.call(a,o)&&b(t,o,a[o]);return t};const _=()=>{var t;const{guidedTourState:a,setSkipped:o}=(0,i.useGuidedTour)(),{formatMessage:l}=(0,f.useIntl)(),{trackUsage:p}=(0,i.useTracking)(),y=Object.entries(Y.Z).map(([u,s])=>({key:u,title:s.home.title,content:e.createElement(i.LinkButton,{onClick:()=>p(s.home.trackingEvent),to:s.home.cta.target,endIcon:e.createElement(H(),null)},l(s.home.cta.title))})),B=(t=y.map(u=>q({isDone:Object.entries(a[u.key]).every(([,s])=>s)},u)).find(u=>!u.isDone))==null?void 0:t.key,x=()=>{o(!0),p("didSkipGuidedtour")};return e.createElement(d.Box,{hasRadius:!0,shadow:"tableShadow",paddingTop:7,paddingRight:4,paddingLeft:7,paddingBottom:4,background:"neutral0"},e.createElement(E.Stack,{spacing:6},e.createElement(h.Typography,{variant:"beta",as:"h2"},l({id:"app.components.GuidedTour.title",defaultMessage:"3 steps to get started"})),e.createElement(J,{sections:y,currentSectionKey:B})),e.createElement(v.Flex,{justifyContent:"flex-end"},e.createElement(L.Button,{variant:"tertiary",onClick:x},l({id:"app.components.GuidedTour.skip",defaultMessage:"Skip the tour"}))))};var ee=n(13260),G=n(70677),te=n(43257),ne=n.n(te),ae=n(77108),oe=n.n(ae),re=n(2807),le=n.n(re),ie=n(27962),se=n.n(ie),ce=n(70555),de=n.n(ce),me=n(4250),pe=n.n(me),ue=n(30153),ge=n.n(ue);const fe=(0,c.default)(le())`
  path {
...
`,Oe=()=>{const{collectionTypes:t,singleTypes:a,isLoading:o}=(0,V.bP)(),{guidedTourState:l,isGuidedTourVisible:p,isSkipped:y}=(0,i.useGuidedTour)(),I=!$(l)&&p&&!y,{push:B}=(0,j.useHistory)(),x=s=>{s.preventDefault(),B("/plugins/content-type-builder/content-types/create-content-type")},u=(0,e.useMemo)(()=>{const s=We=>We.filter(Ve=>Ve.isDisplayed);return s(t).length>1||s(a).length>0},[t,a]);return o?e.createElement(i.LoadingIndicatorPage,null):e.createElement(O.Layout,null,e.createElement(f.FormattedMessage,{id:"HomePage.helmet.title",defaultMessage:"Homepage"},s=>e.createElement(D.Helmet,{title:s[0]})),e.createElement(F.Main,null,e.createElement(je,null,e.createElement("img",{alt:"","aria-hidden":!0,src:W})),e.createElement(d.Box,{padding:10},e.createElement(g.Grid,null,e.createElement(g.GridItem,{col:8,s:12},e.createElement(xe,{onCreateCT:x,hasCreatedContentType:u}))),e.createElement(g.Grid,{gap:6},e.createElement(g.GridItem,{col:8,s:12},I?e.createElement(_,null):e.createElement(De,null)),e.createElement(g.GridItem,{col:4,s:12},e.createElement(Te,null))))))},Fe=(0,e.memo)(Oe)}}]);
