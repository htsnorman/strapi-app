...
`;function ne({customRowComponent:e,component:t,isFromDynamicZone:o,isNestedInDZComponent:p,firstLoopComponentUid:g}){const{modifiedData:m}=(0,U.Z)(),{schema:{attributes:b}}=R()(m,["components",t],{schema:{attributes:[]}});return n.createElement(ve,{isChildOfDynamicZone:o,className:"component-row"},n.createElement("td",{colSpan:12},n.createElement($e,{customRowComponent:e,items:b,targetUid:t,firstLoopComponentUid:g||t,editTarget:"components",isFromDynamicZone:o,isNestedInDZComponent:p,isSub:!0,secondLoopComponentUid:g?t:null})))}ne.defaultProps={component:null,customRowComponent:null,firstLoopComponentUid:null,isFromDynamicZone:!1,isNestedInDZComponent:!1},ne.propTypes={component:s().string,customRowComponent:s().func,firstLoopComponentUid:s().string,isFromDynamicZone:s().bool,isNestedInDZComponent:s().bool};const he=ne;var et=Object.defineProperty,tt=Object.defineProperties,nt=Object.getOwnPropertyDescriptors,be=Object.getOwnPropertySymbols,ot=Object.prototype.hasOwnProperty,rt=Object.prototype.propertyIsEnumerable,Ee=(e,t,o)=>t in e?et(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,at=(e,t)=>{for(var o in t||(t={}))ot.call(t,o)&&Ee(e,o,t[o]);if(be)for(var o of be(t))rt.call(t,o)&&Ee(e,o,t[o]);return e},lt=(e,t)=>tt(e,nt(t));const it=(0,w.default)(l())`
...
`,dt=(0,w.default)(Z.Stack)`
  ...
  justify-content: center;
  align-items: center;
`;function oe({customRowComponent:e,components:t,addComponent:o,name:p,targetUid:g}){const{isInDevelopmentMode:m}=(0,U.Z)(),[b,P]=(0,n.useState)(0),{formatMessage:v}=(0,z.useIntl)(),x=u=>{b!==u&&P(u)},E=()=>{o(p)};return n.createElement(ve,{className:"dynamiczone-row",isFromDynamicZone:!0},n.createElement("td",{colSpan:12},n.createElement(st,{paddingLeft:8},n.createElement(ct,{horizontal:!0,spacing:2},m&&n.createElement("button",{type:"button",onClick:E},n.createElement(dt,{spacing:1},n.createElement(it,null),n.createElement(L.Typography,{variant:"pi",fontWeight:"bold",textColor:"primary600"},v({id:(0,O.Z)("button.component.add"),formatMessage:"Add a component"})))),t.map((u,T)=>n.createElement(_e,{key:u,dzName:p,index:T,component:u,isActive:b===T,isInDevelopmentMode:m,onClick:()=>x(T)})))),n.createElement(pt,null,t.map((u,T)=>{const C={customRowComponent:e,component:u};return n.createElement(M.Box,{tabId:`${T}`,key:u,style:{display:b===T?"block":"none"}},n.createElement("table",null,n.createElement("tbody",null,n.createElement(he,lt(at({},C),{isFromDynamicZone:!0,targetUid:g,key:u})))))}))))}oe.defaultProps={addComponent(){},components:[],customRowComponent:null,name:null},oe.propTypes={addComponent:s().func,components:s().instanceOf(Array),customRowComponent:s().func,name:s().string,targetUid:s().string.isRequired};const ut=oe,mt=(0,w.default)(M.Box)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`;var ft=Object.defineProperty,X=Object.getOwnPropertySymbols,Te=Object.prototype.hasOwnProperty,xe=Object.prototype.propertyIsEnumerable,Ce=(e,t,o)=>t in e?ft(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,gt=(e,t)=>{for(var o in t||(t={}))Te.call(t,o)&&Ce(e,o,t[o]);if(X)for(var o of X(t))xe.call(t,o)&&Ce(e,o,t[o]);return e},yt=(e,t)=>{var o={};for(var p in e)Te.call(e,p)&&t.indexOf(p)<0&&(o[p]=e[p]);if(e!=null&&X)for(var p of X(e))t.indexOf(p)<0&&xe.call(e,p)&&(o[p]=e[p]);return o};const vt=(0,w.default)(M.Box)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
...
`,Se=e=>n.createElement(Bt,null,n.createElement(Dt,jt({width:"20",height:"23",viewBox:"0 0 20 23",fill:"none",xmlns:"http://www.w3.org/2000/svg"},e),n.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M7.02477 14.7513C8.65865 17.0594 11.6046 18.6059 17.5596 18.8856C18.6836 18.9384 19.5976 19.8435 19.5976 20.9688V20.9688C19.5976 22.0941 18.6841 23.0125 17.5599 22.9643C10.9409 22.6805 6.454 20.9387 3.75496 17.1258C0.937988 13.1464 0.486328 7.39309 0.486328 0.593262H4.50974C4.50974 7.54693 5.06394 11.9813 7.02477 14.7513Z"})));Se.propTypes={color:s().string.isRequired};const It=Se,le=({content:e})=>me()(e);le.defaultProps={content:null},le.propTypes={content:s().string};const Zt=le,Ft=(0,w.default)(M.Box)`
  position: relative;
`;var At=c(68314);const ie=({type:e,customField:t,repeatable:o})=>{const{formatMessage:p}=(0,z.useIntl)();let g=e;return["integer","biginteger","float","decimal"].includes(e)?g="number":["string"].includes(e)&&(g="text"),t?n.createElement(L.Typography,null,p({id:(0,O.Z)("attribute.customField"),defaultMessage:"Custom field"})):n.createElement(L.Typography,null,p({id:(0,O.Z)(`attribute.${g}`),defaultMessage:e}),"\xA0",o&&p({id:(0,O.Z)("component.repeatable"),defaultMessage:"(repeatable)"}))};ie.defaultProps={customField:null,repeatable:!1},ie.propTypes={type:s().string.isRequired,customField:s().string,repeatable:s().bool};const kt=ie;var Nt=Object.defineProperty,je=Object.getOwnPropertySymbols,Vt=Object.prototype.hasOwnProperty,zt=Object.prototype.propertyIsEnumerable,Be=(e,t,o)=>t in e?Nt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,De=(e,t)=>{for(var o in t||(t={}))Vt.call(t,o)&&Be(e,o,t[o]);if(je)for(var o of je(t))zt.call(t,o)&&Be(e,o,t[o]);return e};function se({configurable:e,customField:t,editTarget:o,firstLoopComponentUid:p,isFromDynamicZone:g,name:m,onClick:b,relation:P,repeatable:v,secondLoopComponentUid:x,target:E,targetUid:u,type:T}){const{contentTypes:C,isInDevelopmentMode:k,removeAttribute:D}=(0,U.Z)(),{formatMessage:F}=(0,z.useIntl)(),j=T==="relation"&&P.includes("morph"),I=["integer","biginteger","float","decimal"].includes(T)?"number":T,N=R()(C,[E],{}),K=R()(N,["schema","displayName"],""),G=R()(N,"plugin"),pe=E?"relation":I,Q=()=>{j||e!==!1&&b(o,x||p||u,m,T,t)};let A;return x&&p?A=2:p?A=1:A=0,n.createElement(Ft,De({as:"tr"},(0,i.onRowClick)({fn:Q,condition:k&&e&&!j})),n.createElement("td",{style:{position:"relative"}},A!==0&&n.createElement(It,{color:g?"primary200":"neutral150"}),n.createElement(Z.Stack,{paddingLeft:2,spacing:4,horizontal:!0},n.createElement(At.Z,{type:pe,customField:t}),n.createElement(L.Typography,{fontWeight:"bold"},m))),n.createElement("td",null,E?n.createElement(L.Typography,null,F({id:(0,O.Z)(`modelPage.attribute.${j?"relation-polymorphic":"relationWith"}`),defaultMessage:"Relation with"}),"\xA0",n.createElement("span",{style:{fontStyle:"italic"}},n.createElement(Zt,{content:K}),"\xA0",G&&`(${F({id:(0,O.Z)("from"),defaultMessage:"from"})}: ${G})`)):n.createElement(kt,{type:T,customField:t,repeatable:v})),n.createElement("td",null,k?n.createElement(_.Flex,De({justifyContent:"flex-end"},i.stopPropagation),e?n.createElement(Z.Stack,{horizontal:!0,spacing:1},!j&&n.createElement(Me.IconButton,{onClick:Q,label:`${F({id:"app.utils.edit",defaultMessage:"Edit"})} ${m}`,noBorder:!0,icon:n.createElement($(),null)}),n.createElement(Me.IconButton,{onClick:Y=>{Y.stopPropagation(),D(o,m,x||p||"")},label:`${F({id:"global.delete",defaultMessage:"Delete"})} ${m}`,noBorder:!0,icon:n.createElement(Mt(),null)})):n.createElement(Pt(),null)):n.createElement(M.Box,{height:(0,i.pxToRem)(32)})))}se.defaultProps={configurable:!0,customField:null,firstLoopComponentUid:null,isFromDynamicZone:!1,onClick(){},relation:"",repeatable:!1,secondLoopComponentUid:null,target:null,targetUid:null,type:null},se.propTypes={configurable:s().bool,customField:s().string,editTarget:s().string.isRequired,firstLoopComponentUid:s().string,isFromDynamicZone:s().bool,name:s().string.isRequired,onClick:s().func,relation:s().string,repeatable:s().bool,secondLoopComponentUid:s().string,target:s().string,targetUid:s().string,type:s().string};const Ut=(0,n.memo)(se),Wt=e=>{let t;switch(e){case"date":case"datetime":case"time":case"timestamp":t="date";break;case"integer":case"biginteger":case"decimal":case"float":t="number";break;case"string":case"text":t="text";break;case"":t="relation";break;default:t=e}return t};var Ht=c(85557),Kt=c.n(Ht);const Gt={collectionTypesConfigurations:[{action:"plugin::content-manager.collection-types.configure-view",subject:null}],componentsConfigurations:[{action:"plugin::content-manager.components.configure-layout",subject:null}],singleTypesConfigurations:[{action:"plugin::content-manager.single-types.configure-view",subject:null}]},ce=({disabled:e,isTemporary:t,isInContentTypeView:o,contentTypeKind:p,targetUid:g})=>{const{formatMessage:m}=(0,z.useIntl)(),{push:b}=(0,ee.useHistory)(),{collectionTypesConfigurations:P,componentsConfigurations:v,singleTypesConfigurations:x}=Gt,E=m({id:"content-type-builder.form.button.configure-view"});let u=P;const T=()=>(t||b(o?`/content-manager/collectionType/${g}/configurations/edit`:`/content-manager/components/${g}/configurations/edit`),!1);return o&&p==="singleType"&&(u=x),o||(u=v),n.createElement(i.CheckPermissions,{permissions:u},n.createElement(H.Button,{startIcon:n.createElement(Kt(),null),variant:"tertiary",onClick:T,disabled:t||e},E))};ce.defaultProps={contentTypeKind:"collectionType",isInContentTypeView:!0,isTemporary:!1,targetUid:""},ce.propTypes={disabled:s().bool.isRequired,contentTypeKind:s().string,isInContentTypeView:s().bool,isTemporary:s().bool,targetUid:s().string};const Xt=(0,n.memo)(ce);var Jt=Object.defineProperty,Qt=Object.defineProperties,Yt=Object.getOwnPropertyDescriptors,Ie=Object.getOwnPropertySymbols,qt=Object.prototype.hasOwnProperty,_t=Object.prototype.propertyIsEnumerable,Ze=(e,t,o)=>t in e?Jt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,en=(e,t)=>{for(var o in t||(t={}))qt.call(t,o)&&Ze(e,o,t[o]);if(Ie)for(var o of Ie(t))_t.call(t,o)&&Ze(e,o,t[o]);return e},tn=(e,t)=>Qt(e,Yt(t)),nn=(e,t,o)=>new Promise((p,g)=>{var m=v=>{try{P(o.next(v))}catch(x){g(x)}},b=v=>{try{P(o.throw(v))}catch(x){g(x)}},P=v=>v.done?p(v.value):Promise.resolve(v.value).then(m,b);P((o=o.apply(e,t)).next())});const on=()=>{const{initialData:e,modifiedData:t,isInDevelopmentMode:o,isInContentTypeView:p,submitData:g}=(0,U.Z)(),{formatMessage:m}=(0,z.useIntl)(),{trackUsage:b}=(0,i.useTracking)(),P=(0,ee.useRouteMatch)("/plugins/content-type-builder/:kind/:currentUID"),{onOpenModalAddComponentsToDZ:v,onOpenModalAddField:x,onOpenModalEditField:E,onOpenModalEditSchema:u,onOpenModalEditCustomField:T}=(0,fe.Z)(),C=p?"contentType":"component",k=[C,"schema","attributes"],D=R()(t,[C,"uid"]),F=R()(t,[C,"isTemporary"],!1),j=R()(t,[C,"schema","kind"],null),I=R()(t,k,[]),N=We()(e,[C,"plugin"]),K=!ue()(t,e),G=p?"contentType":"component",pe=B=>{v({dynamicZoneTarget:B,targetUid:D})},Q=(B,Fe,Ae,ke,Ne)=>nn(void 0,null,function*(){const Ve=Wt(ke);Ne?T({forTarget:B,targetUid:Fe,attributeName:Ae,attributeType:Ve,customFieldUid:Ne}):E({forTarget:B,targetUid:Fe,attributeName:Ae,attributeType:Ve,step:ke==="component"?"2":null})});let A=R()(t,[C,"schema","displayName"],"");const Y=R()(t,[C,"schema","kind"],""),q=(P==null?void 0:P.params.currentUID)==="create-content-type";!A&&q&&(A=m({id:(0,O.Z)("button.model.create"),defaultMessage:"Create new collection type"}));const rn=()=>{const B=Y||C;B==="collectionType"&&b("willEditNameOfContentType"),B==="singleType"&&b("willEditNameOfSingleType"),u({modalType:C,forTarget:C,targetUid:D,kind:B})};return n.createElement(n.Fragment,null,n.createElement(ee.Prompt,{message:m({id:(0,O.Z)("prompt.unsaved")}),when:K}),n.createElement(de.HeaderLayout,{id:"title",primaryAction:o&&n.createElement(Z.Stack,{horizontal:!0,spacing:2},!q&&n.createElement(H.Button,{startIcon:n.createElement(l(),null),variant:"secondary",onClick:()=>{x({forTarget:G,targetUid:D})}},m({id:(0,O.Z)("button.attributes.add.another")})),n.createElement(H.Button,{startIcon:n.createElement(y(),null),onClick:()=>g(),type:"submit",disabled:ue()(t,e)},m({id:"global.save",defaultMessage:"Save"}))),secondaryAction:o&&!N&&!q&&n.createElement(H.Button,{startIcon:n.createElement($(),null),variant:"tertiary",onClick:rn},m({id:"app.utils.edit",defaultMessage:"Edit"})),title:me()(A),subtitle:m({id:(0,O.Z)("listView.headerLayout.description"),defaultMessage:"Build the data architecture of your content"}),navigationAction:n.createElement(i.Link,{startIcon:n.createElement(a(),null),to:"/plugins/content-type-builder/"},m({id:"global.back",defaultMessage:"Back"}))}),n.createElement(de.ContentLayout,null,n.createElement(Z.Stack,{spacing:4},n.createElement(_.Flex,{justifyContent:"flex-end"},n.createElement(Z.Stack,{horizontal:!0,spacing:2},n.createElement(Xt,{key:"link-to-cm-settings-view",targetUid:D,isTemporary:F,isInContentTypeView:p,contentTypeKind:j,disabled:q}))),n.createElement(M.Box,{background:"neutral0",shadow:"filterShadow",hasRadius:!0},n.createElement($e,{items:I,customRowComponent:B=>n.createElement(Ut,tn(en({},B),{onClick:Q})),addComponentToDZ:pe,targetUid:D,editTarget:G,isMain:!0})))))}}}]);
